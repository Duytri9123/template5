      ...
      <div class="w-full flex lg:justify-end justify-center py-10">
        <div class="rounded-xl shadow-lg">
          <img
            ...
            alt="Gói khám sàng lọc ung thư tuyến giáp"
            class="object-cover"
          />
        </div>
      </div>

      <div class="bg-white shadow-xl rounded-2xl overflow-hidden w-full max-w-lg mx-auto">
        <div class="bg-background text-white px-6 py-2">
          <h2
            class="text-lg md:text-xl font-semibold text-center text-white pt-1 rounded-t-xl"
          >
            ĐĂNG KÝ TƯ VẤN MIỄN PHÍ
          </h2>
          <p class="text-center text-white mt-2 mb-4 text-sm">
            Đặt hẹn ngay để nhận tư vấn và chúng tôi sẽ xếp lịch khám kịp thời!
          </p>
        </div>

        <form class="space-y-4 p-6 flex flex-col items-center">
          <input
            type="text"
            placeholder="Họ và tên (*)"
            class="w-full px-4 py-2 bg-[#F5F5F5] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300"
          />
          <input
            type="tel"
          ...
          <textarea
            ...
            class="w-full px-4 py-2 bg-[#F5F5F5] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none"
          ></textarea>

          <button
            type="submit"
            class="cursor-pointer max-w-72 bg-button text-white lg:text-base text-sm font-medium p-2 rounded-full flex items-center justify-center gap-2"
          >
            <svg
              width="24"
              height="24"
